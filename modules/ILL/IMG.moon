...
if haveDepCtrl
	depctrl\register {:IMG, :LIBBMP, :LIBJPG, :LIBGIF, :LIBPNG, :Tracer, :Potrace, version: module_version}
else
	{:IMG, :LIBBMP, :LIBJPG, :LIBGIF, :LIBPNG, :Tracer, :Potrace, version: module_version}